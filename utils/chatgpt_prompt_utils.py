...
def getChatGPTResponse(content, model="gpt-3.5-turbo"):
...
def get_exam_questions_from_chatgpt(course: str, chapter: str, topic: str):
    ...
    This function utilizes the getChatGPTResponse() function to generate
...
def convert_exam_question_to_dict(question: str):
    ...
    This function utilizes the getChatGPTResponse() function to ask ChatGPT to parse the
    ...
    Raises:
        Exception: If an error occurs while converting the response from getChatGPTResponse() to a dictionary.
    """
    ...
    res = getChatGPTResponse(new_prompt)
